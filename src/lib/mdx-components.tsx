  ...
  return {
    ...
    mermaid: (props: MermaidProps) => (
      <div
        role="img"
        aria-label="Diagram"
        className="my-2 md:my-4 overflow-x-auto rounded-xl bg-background/60 p-4 md:p-5 shadow-[0_0_0_1px_oklch(0_0_0/0.08),inset_0_1px_2px_oklch(0_0_0/0.05)] dark:shadow-[0_0_0_1px_oklch(1_0_0/0.1),inset_0_1px_2px_oklch(1_0_0/0.04)]"
      >

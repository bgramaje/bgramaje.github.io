...
```mermaid
sequenceDiagram
participant Node as IoT Node<br/>(ESP32-S3 + SX1262)
participant GW as LoRaWAN Gateway<br/>(Packet Forwarder)
participant CS as ChirpStack<br/>(LoRaWAN Network Server)
participant MQTT as MQTT Broker
participant MS as Microservice<br/>(Request/Response Manager)
participant DB as MongoDB Database
participant Meteor as MeteorJS Application<br/>(Web UI + Data Management)

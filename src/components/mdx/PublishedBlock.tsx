...
export function PublishedBlock({
  ...
  return (
    <div className={cn("flex items-center justify-end gap-1 mb-2", className)}>
      <span className="whitespace-nowrap text-terminal-muted text-[0.95rem] font-sans leading-none">
        {label}{" "}
        <strong className="text-slate-200 font-semibold">{formatted}</strong>
      </span>
    </div>
  );
}

    ...
    <div className="space-y-3 mx-2">
        {publications.map((pub) => (
          <div
            ...
            className="flex items-start gap-3 cursor-pointer rounded-lg px-2 py-1.5 -mx-2 -my-1.5 hover:bg-border/25 transition-colors"
          >
            <span className="text-success shrink-0 mt-0.5">▸</span>
            <div className="flex-1 min-w-0">
              <p className="text-foreground text-sm font-medium min-w-0 truncate">{pub.title}</p>

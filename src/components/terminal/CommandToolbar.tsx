      ...
      {COMMAND_ITEMS.map((item) => (
        <motion.button
          ...
          className={cn(
            ...
            "bg-transparent text-terminal-muted hover:text-terminal-text border border-transparent hover:border-terminal-border/50 hover:bg-terminal-border/10",
            "transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terminal-success focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950"
          )}
        ...
        >
          ...
          <span className="absolute right-full top-1/2 -translate-y-1/2 mr-1.5 px-2 py-1 rounded border border-terminal-border/60 bg-neutral-950/95 text-terminal-text text-xs whitespace-nowrap opacity-0 pointer-events-none transition-opacity duration-150 group-hover:opacity-100 group-focus-visible:opacity-100 z-10">
            {item.title}
          </span>
        </motion.button>
      ))}
